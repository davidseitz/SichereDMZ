...
REPORT_FILENAME="zap_base_report_${TIMESTAMP}.html"
...
# --- STEP 2: RUN THE SCAN ---
echo "[Step 2/3] Running ZAP Baseline Scan. This may take 1-5 minutes..."

# Command Breakdown:
# zap-baseline.py : The lightweight scan script
# -t : Target URL
